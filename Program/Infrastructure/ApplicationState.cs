...
namespace MEATaste.Infrastructure
{
    public class ApplicationState
    {
        ...
        public StateProperty<ChannelsDictionary> DictionarySelectedChannels { get; }
        ...
        public ApplicationState(StatePropertyFactory statePropertyFactory)
        {
            ...
            DictionarySelectedChannels = statePropertyFactory.Create<ChannelsDictionary>(null, EventType.SelectedChannelsChanged);
